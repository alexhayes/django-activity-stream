...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.searchable'
        db.add_column(u'actstream_action', 'searchable',
    ...
    def backwards(self, orm):
        # Deleting field 'Action.searchable'
        db.delete_column(u'actstream_action', 'searchable')
    ...
    models = {
        u'actstream.action': {
            ...
            'searchable': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
